...
const ShowBook = () => {
  ...
  return (
    <div className='p-4'>
    <BackButton />
    <h1 className='text-3xl my-4'>Livro detalhes</h1>
    {loading ? (
      <Spinner />
    ) : (
      <div className='flex flex-col border-2 border-orange-400 rounded-xl w-fit p-4'>
        ...
        <div className='my-4'>
          <span className='text-xl mr-4 text-gray-500'>Ano de Publicação</span>
          <span>{book.publishYear}</span>
        </div>
        <div className='my-4'>
          <span className='text-xl mr-4 text-gray-500'>Quando foi criado</span>
